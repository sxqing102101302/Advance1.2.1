...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        writeTunnelRules(p4info_helper, ingress_sw=s2, egress_sw=s1, tunnel_id=150,
                         dst_eth_addr="08:00:00:00:01:11", dst_ip_addr="10.0.1.1")
        # Write the rules that tunnel traffic from h2 to h3
        writeTunnelRules(p4info_helper, ingress_sw=s2, egress_sw=s3, tunnel_id=200,
                         dst_eth_addr="08:00:00:00:03:33", dst_ip_addr="10.0.3.3")
        # Write the rules that tunnel traffic from h3 to h2
        writeTunnelRules(p4info_helper, ingress_sw=s3, egress_sw=s2, tunnel_id=250,
                         dst_eth_addr="08:00:00:00:02:22", dst_ip_addr="10.0.2.2")
        ...
        writeTunnelRules(p4info_helper, ingress_sw=s3, egress_sw=s1, tunnel_id=350,
                         dst_eth_addr="08:00:00:00:01:11", dst_ip_addr="10.0.1.1")
        ...
        while True:
            ...
            print('----- s1->s2 -----')
            pcount1 = printCounter(p4info_helper, s1, "MyIngress.ingressTunnelCounter", 100)
            printCounter(p4info_helper, s2, "MyIngress.egressTunnelCounter", 100)
            print('----- s2->s1 -----')
            printCounter(p4info_helper, s2, "MyIngress.ingressTunnelCounter", 150)
            printCounter(p4info_helper, s1, "MyIngress.egressTunnelCounter", 150)
            ...
            print('----- s3->s2 -----')
            printCounter(p4info_helper, s3, "MyIngress.ingressTunnelCounter", 250)
            printCounter(p4info_helper, s2, "MyIngress.egressTunnelCounter", 250)
            if pcount3>count3:
               count3=pcount3
            ...
            print('----- s3->s1 -----')
            printCounter(p4info_helper, s3, "MyIngress.ingressTunnelCounter", 350)
            printCounter(p4info_helper, s1, "MyIngress.egressTunnelCounter", 350)
            if pcount5>count5:
               count5=pcount5
